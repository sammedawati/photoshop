                    ...
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-center px-6">
                        <div className="max-w-4xl animate-in fade-in zoom-in duration-1000">
                            ...
                            <p className="text-xl md:text-2xl text-white/90 font-light italic mb-8">
                                Preserving the love and laughter of your family bond
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center mb-16 text-neutral-600 leading-relaxed">
                        <p className="text-lg mb-6">
                            Family is where our story begins. Our family sessions are designed to capture
                            the unique dynamics and deep connections that make your family special.
                            From playful moments to heartfelt embraces, we create timeless portraits
                            that honor your heritage and preserve your most precious memories.
                        </p>
