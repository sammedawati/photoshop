...
const propPairs = [
    { id: 1, images: [heroBaby, heroBaby], title: "Little Explorer Tents" },
    { id: 2, images: [heroBaby, heroBaby], title: "Dreamy Cloud Swings" },
    { id: 3, images: [heroBaby, heroBaby], title: "Nature's Nest Settlers" },
    { id: 4, images: [heroBaby, heroBaby], title: "Classic Library Themes" },
];
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center mb-20">
                        ...
                        <p className="text-neutral-500 max-w-2xl mx-auto font-light text-sm tracking-wide leading-relaxed">
                            Whimsical, safe, and imaginative themes curated for your baby's unique personality.
                        </p>
                    </div>
