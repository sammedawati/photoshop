...
import heroTraditional from "@/assets/hero-traditional.jpg";
            ...
            <main className="pt-24 pb-16">
                    ...
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-center px-6">
                        <div className="max-w-4xl animate-in fade-in zoom-in duration-1000">
                            ...
                            <p className="text-xl md:text-2xl text-white/90 font-light italic mb-8">
                                Preserving cultural heritage in every frame
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center mb-6 text-neutral-600 leading-relaxed">
                        <p className="text-lg mb-6">
                            Our traditional photography sessions focus on cultural attire,
                            rituals, and family heritage. We create timeless portraits that
                            celebrate your roots and traditions with elegance.
                        </p>

                        {/* Action Buttons */}
                        <div className="flex flex-col sm:flex-row gap-6 justify-center mt-6">
                            <Link
                                to="/portfolio/traditional/packages"
                ...
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[traditionalFeatured1, traditionalFeatured2, traditionalFeatured3, traditionalFeatured4].map((img, idx) => (
                            <div
                                key={idx}
                            ...
                            >
                                <img
                                    src={img}
                                    alt={`Traditional featured ${idx + 1}`}
                                    className="w-full h-full object-cover"
                                />
