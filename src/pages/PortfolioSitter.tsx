            ...
            <main className="pt-20">
                <section className="relative h-[60vh] overflow-hidden flex items-center justify-center">
                    <div className="absolute inset-0 z-0 scale-110 animate-[zoom-in_20s_ease-out]">
                        <img src={heroSitter} alt="Sitter Portfolio" className="w-full h-full object-cover" />
                ...
                <section className="py-24 container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <p className="text-xl text-neutral-600 font-light leading-relaxed italic">
                            "Capturing those precious expressions when they first sit up and explore."
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 justify-center items-center max-w-4xl mx-auto">
                        ...
                        >
                            <img src={heroSitter} alt="Sitter Packages" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                        ...
                        <Link
                            ...
                            className="group relative w-full md:w-1/2 aspect-[16/9] overflow-hidden rounded-[2rem] shadow-2xl transition-transform duration-500 hover:-translate-y-2"
                        >
                            <img src={heroSitter} alt="Sitter Themes" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 shadow-inner" />
...
export default PortfolioSitter;
