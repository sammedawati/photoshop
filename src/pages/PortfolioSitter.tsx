                    ...
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-center px-6">
                        <div className="max-w-4xl animate-in fade-in zoom-in duration-1000">
                            ...
                            <p className="text-xl md:text-2xl text-white/90 font-light italic mb-8">
                                Exploring the world, one sit-up at a time
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center mb-16 text-neutral-600 leading-relaxed">
                        <p className="text-lg mb-6">
                            The Sitter stage, typically between 6 to 9 months, is one of our favorites.
                            Your baby is full of curiosity, big expressions, and new skills.
                            We capture these precious moments of discovery when they first sit up,
                            interact with props, and show off those beautiful gummy smiles.
                        </p>
